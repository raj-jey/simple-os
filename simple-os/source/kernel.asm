...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to SYNTAX OS. it is a modified version of JOSH OS. Modified By Powsikan.  type help for help menu.", 0x00
	strPrompt		db	"SYNTAX>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"SYNTAX", 0x00	;OS details
